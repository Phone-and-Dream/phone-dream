...
import { User, Bell, Shield, Eye, Trash2, Loader2, Wallet } from 'lucide-react';
...
export default function RecipientSettings() {
  ...
  const [xpAlerts, setXpAlerts] = useState(true);
  const [taskReminders, setTaskReminders] = useState(true);
  const [matchAlerts, setMatchAlerts] = useState(true);

  // Privacy settings
  const [showOnLeaderboard, setShowOnLeaderboard] = useState(true);
  const [showOnDreamBoard, setShowOnDreamBoard] = useState(true);
  ...
  return (
    <DashboardLayout role="recipient">
      <div className="max-w-2xl mx-auto space-y-8">
        <div>
          <BackButton to="/recipient/dashboard" className="mb-4" />
        ...
        <div className="glass-card rounded-2xl p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">Show on Dream Board</p>
                <p className="text-sm text-muted-foreground">Allow donors to find you</p>
              </div>
              <Switch checked={showOnDreamBoard} onCheckedChange={setShowOnDreamBoard} />
            </div>
        ...
        <div className="glass-card rounded-2xl p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">XP Alerts</p>
                <p className="text-sm text-muted-foreground">Notify when you earn XP</p>
              </div>
              <Switch checked={xpAlerts} onCheckedChange={setXpAlerts} />
            </div>
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">Task Reminders</p>
                <p className="text-sm text-muted-foreground">Remind about incomplete tasks</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Notify when matched with a donor</p>
              </div>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  and remove your data from our servers. Your application history and any
                  received devices will be handled according to our terms.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
