...
import { ArrowRight, Smartphone, Heart, Users, Gift, Sparkles, Globe, ChevronDown, ChevronUp, Laptop, Tablet, Monitor, Keyboard, HardDrive, Eye, Target, Handshake, BarChart3, Building2, LucideIcon } from 'lucide-react';
          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mt-10 pt-8 border-t border-border/50 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                <p className="text-lg md:text-xl font-medium text-foreground mb-4">Ready to make an impact?</p>
                <Button 
                  size="lg"
